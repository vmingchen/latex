...
with the School of Computer Science and Engineering, Beihang University, Beijing, 100191 China.}% <-this % stops a space
\thanks{Manuscript received April 20, 2009.}}


% The paper headers
\markboth{Special Issue on Model Order Selection in Signal Processing Systems, 2009}%
...
\begin{figure}[t]
    \centering
    \includegraphics[width=7cm]{system.mps}
...
\begin{figure}[t]
  ...
  \begin{minipage}[htb]{.49\linewidth}
    \includegraphics[width=4.2cm,height=2.5cm]{pc1.mps}
    \centerline{(a)}\medskip
  \end{minipage}
  \begin{minipage}[htb]{.49\linewidth}
    \includegraphics[width=4.2cm,height=2.5cm]{pc2.mps}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=8cm,height=6cm]{addexp.eps}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=8cm,height=7cm]{full_context.eps}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=8.5cm,height=6.5cm]{gray_compare.eps}
...
\bibliographystyle{IEEEtran}
\bibliography{IEEEabrv,../wmbib}

\vspace*{-2\baselineskip}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../../misc/mingchen.eps}}]{Ming Chen}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../../misc/zhenyongchen.eps}}]{Zhenyong Chen}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../../misc/xiaozeng.eps}}]{Xiao Zeng}
    received his B.S. degree in Computer Science and Technology from Beihang University, Beijing,
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../../misc/zhangxiong.eps}}]{Zhang Xiong}
